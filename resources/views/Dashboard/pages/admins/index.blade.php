...
@section('pageTitle') <i class="fa fa-star"></i> {{ trans('backend.admins') }} @endsection
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            ...
            <div class="button-page-header">
                <a class="btn btn-block btn-primary" href="{{ route('admins.create') }}">
                    ...
                    <tbody>
                        @foreach( $admins as $index=>$admin )
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    <img style="width:40px;height:35px" src="{{ asset($admin->avatar) }}" alt="">
                                </td>
                                ...
                                <div class="btn-group manage-button" title="View Account">
                                    ...
                                    <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                                        ...
                                        @if( $admin->status == 0 )
                                            <li>
                                                <a title="{{ trans('backend.activation') }} {{ trans('backend.record') }}" href="{{ route('admins.activation' , $admin->id) }}">
                                                    <i class="fa fa-fw fa-check"></i> {{ trans('backend.activation') }}
                                                </a>
                                            </li>
                                        @else
                                            <li>
                                                <a title="{{ trans('backend.disable') }} {{ trans('backend.record') }}" href="{{ route('admins.activation' , $admin->id) }}">
                                        ...
                                        <li>
                                            <a title="{{ trans('backend.show') }} {{ trans('backend.record') }}" href="{{ route('admins.show' , $admin->id) }}">
                                                <i class="fa fa-fw fa-eye"></i> {{ trans('backend.show') }}
                                            </a>
                                        </li>
                                        
                                        <li>
                                            <a title="{{ trans('backend.edit') }} {{ trans('backend.record') }}" href="{{ route('admins.edit' , $admin->id) }}">
