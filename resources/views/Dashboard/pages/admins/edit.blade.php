...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('admins.update' , $admin->id) }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:250px;height:200px;margin-top:5px" class="image-preview img-thumbnail" src="{{ asset($admin->avatar) }}" alt="">
                            </div>
                        </div>
                    </div>
