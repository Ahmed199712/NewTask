        ...
        <div class="box-header with-border">
            ...
            @if( $admin->status == 0 )
                <div class="button-page-header" style="margin-top:5px">
                    <a class="btn btn-block btn-success" href="{{ route('admins.activation' , $admin->id) }}">
                    <i class="fa fa-check fa-fw fa-lg"></i> {{ trans('backend.activation') }}</a>
                </div>
            @else
                <div class="button-page-header" style="margin-top:5px">
                    <a class="btn btn-block btn-danger" href="{{ route('admins.activation' , $admin->id) }}">
                    <i class="fa fa-close fa-fw fa-lg"></i> {{ trans('backend.disable') }}</a>
                </div>
            @endif
            
            <div class="button-page-header" style="margin-top:5px">
                <a class="btn btn-block btn-info" href="{{ route('admins.edit' , $admin->id) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:100%;height:270px;margin-top:5px" class="image-preview img-thumbnail" src="{{ asset($admin->avatar) }}" alt="">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <h4 style="margin:0">
                                        <p>{{ $admin->created_at->format('Y-d-m') }}</p>
                                        <p>{{ $admin->created_at->format('H:i sa') }}</p>
                                    </h4>
                                </div>
                            </div>
